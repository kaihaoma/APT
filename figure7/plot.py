...
multi_machines_path = "outputs/hidden_dim"
...
if __name__ == "__main__":
    # [NOTE] Multi-machines Experiment
    # draw hidden_dim
    # scatter_multi_machines = [[3, 3, 3, 0], [3, 3, 3, 0], [2, 2, 2, 3]]
    scatter_hidden_dim = make_scatter_strategy(
        file_path="outputs/costmodel.csv",
        include_dict={
            "world_size": 16,
            "gpu_cache_mem": 4,
            "model": "SAGE",
    ...
    preprocess_data(
        ...
        key_name="hidden_dim",
        save_dir=multi_machines_path,
        xlabels=[32, 64, 128, 256],
    )
    draw_stacked_bar(
        path_dir=multi_machines_path,
        xlabels=[32, 64, 128, 256],
        xlabel="Hidden Dimension",
        ...
        legend=False,
        save_path="outputs/multi_machines.pdf",
    )
