...
rm -rf outputs/costmodel_fanout.csv
rm -rf outputs/fanout
...
do
    ...
    python mp_runner_fanout.py --num_epochs 10 --fan_out ${fanout} --logs_dir outputs/results_fanout.csv --costmodel_log outputs/costmodel_fanout.csv --tag ${configs} --configs_path ${configs_path} --cache_mode dryrun
    done
done
