...
AtomicCAS(uint64_t *const address, const uint64_t compare, const uint64_t val) {
  // match the type of "::atomicCAS", so ignore lint warning
  using Type = unsigned long long int;  // NOLINT
...
AtomicCAS(uint32_t *const address, const uint32_t compare, const uint32_t val) {
  // match the type of "::atomicCAS", so ignore lint warning
  using Type = int;  // NOLINT
...
inline __device__ uint64_t
AtomicMin(uint64_t *const address, const uint64_t val) {
  // match the type of "::atomicCAS", so ignore lint warning
  using Type = unsigned long long int;  // NOLINT
...
inline __device__ uint32_t
AtomicMin(uint32_t *const address, const uint32_t val) {
  // match the type of "::atomicCAS", so ignore lint warning
